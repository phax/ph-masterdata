...
public final class StringBICValidator extends AbstractStringValidator
{
  @Nonnull
  public IValidationResult validate (@Nullable final String sValue)
  {
    if (BICManager.isValidBIC (sValue))
      return ValidationResultSuccess.getInstance ();
    return new ValidationResultError (ESwiftErrorTexts.INVALID_BIC);
  }
}
