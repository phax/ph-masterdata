 ...
 */
package com.helger.masterdata.trade.validation;
...
public final class StringIncotermValidator extends AbstractStringValidator
{
  @Nonnull
  public IValidationResult validate (@Nullable final String sValue)
  {
    if (EIncoterm.getFromIDOrNull (sValue) != null)
      return ValidationResultSuccess.getInstance ();
    return new ValidationResultError (ETradeErrorTexts.INVALID_DELIVERY_TERMS);
  }
}
