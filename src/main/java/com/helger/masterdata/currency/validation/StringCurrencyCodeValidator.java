 ...
 */
package com.helger.masterdata.currency.validation;
...
public final class StringCurrencyCodeValidator extends AbstractStringValidator
{
  ...
  {
    if (ECurrency.getFromIDOrNull (sValue) != null)
      return ValidationResultSuccess.getInstance ();
    return new ValidationResultError (ECurrencyErrorTexts.INVALID_CURRENCY_CODE);
  }
}
