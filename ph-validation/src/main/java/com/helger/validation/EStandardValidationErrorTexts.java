 ...
 */
@Translatable
public enum EStandardValidationErrorTexts implements IHasDisplayTextWithArgs
{
  ...
  INVALID_DATE ("Das Datum ist ungültig. Geben Sie den Wert in der Form [{0}] an.",
                "The date is invalid. Specify the value in the form [{0}]."),
  INVALID_DATETIME ("Das Datum mit Uhrzeit ist ungültig. Geben Sie den Wert in der Form [{0}] an.",
                    "The date and time is invalid. Specify the value in the form [{0}]."),
  INVALID_DOUBLE ("Die Gleitkommazahl ist ungültig.", "The floating point number is invalid."),
  INVALID_DOUBLE_RANGE ("Die Gleitkommazahl ist nicht im gültigen Bereich {0}-{1}.",
                        "The floating point number is not in the valid range {0}-{1}."),
  ...
  INVALID_INT_RANGE ("Die Ganzzahl ist nicht im gültigen Bereich {0}-{1}.",
                     "The integer number is not in the valid range {0}-{1}."),
  ...
  INVALID_MINLENGTH ("Der Wert ist zu kurz. Er muss mindestens {0} Zeichen enthalten.",
                     "The value is too short. The minimum required length is {0}."),
  INVALID_MAXLENGTH ("Der Wert ist zu lang. Er darf maximal {0} Zeichen enthalten.",
                     "The value is too long. The maximum allowed length is {0}."),
  INVALID_REGEX ("Der Wert entspricht nicht dem regulären Ausdruck: {0}",
                 "The value does not match the regular expression: {0}"),
  INVALID_TIME ("Die Uhrzeit ist ungültig. Geben Sie den Wert in der Form [{0}] an.",
                "The time is invalid. Specify the value in the form [{0}]."),
