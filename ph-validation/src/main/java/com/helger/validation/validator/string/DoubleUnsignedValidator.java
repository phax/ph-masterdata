...
@Immutable
public class DoubleUnsignedValidator extends AbstractStringValidator
{
  private final boolean m_bZeroIsAllowed;

  public DoubleUnsignedValidator (final boolean bZeroIsAllowed)
  {
  ...
  public boolean equals (final Object o)
  {
    ...
    if (!super.equals (o))
      return false;
    final DoubleUnsignedValidator rhs = (DoubleUnsignedValidator) o;
