...
/**
 * Validator for email addresses. Uses the {@link EmailAddressHelper} class
 * explicitly not using a MX check if enabled.
 *
 * @author Philip Helger
 */
@Immutable
public class StringEmailAddressNoMXCheckValidator extends AbstractStringValidator
{
  @Nonnull
  public IValidationResult validate (@Nullable final String sValue)
  {
    if (EmailAddressHelper.isValid (sValue))
