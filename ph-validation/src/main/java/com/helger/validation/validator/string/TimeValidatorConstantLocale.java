...
/**
 * Validating time values with a fixed locale.
 *
 * @author Philip Helger
 */
@Immutable
public class TimeValidatorConstantLocale extends AbstractStringTimeValidator
{
  private final Locale m_aParseLocale;

  public TimeValidatorConstantLocale (@Nonnull final Locale aParseLocale)
  {
  ...
  public boolean equals (final Object o)
  {
    ...
    if (!super.equals (o))
      return false;
    final TimeValidatorConstantLocale rhs = (TimeValidatorConstantLocale) o;
