...
@Immutable
public class IntUnsignedValidator extends AbstractStringValidator
{
  private final boolean m_bZeroIsAllowed;

  public IntUnsignedValidator (final boolean bZeroIsAllowed)
  {
  ...
  public boolean equals (final Object o)
  {
    ...
    if (!super.equals (o))
      return false;
    final IntUnsignedValidator rhs = (IntUnsignedValidator) o;
