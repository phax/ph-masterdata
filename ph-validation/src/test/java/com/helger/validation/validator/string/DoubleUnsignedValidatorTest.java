...
public final class DoubleUnsignedValidatorTest
{
  ...
  {
    CommonsTestHelper.testDefaultImplementationWithEqualContentObject (new DoubleUnsignedValidator (true),
                                                                       new DoubleUnsignedValidator (true));
    CommonsTestHelper.testDefaultImplementationWithEqualContentObject (new DoubleUnsignedValidator (false),
                                                                       new DoubleUnsignedValidator (false));
    CommonsTestHelper.testDefaultImplementationWithDifferentContentObject (new DoubleUnsignedValidator (true),
                                                                           new DoubleUnsignedValidator (false));
  }
}
