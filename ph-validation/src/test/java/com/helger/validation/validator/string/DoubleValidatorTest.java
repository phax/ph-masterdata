 ...
 */
public final class DoubleValidatorTest
{
  @Test
  public void testAll ()
  {
    final DoubleValidator v = new DoubleValidator ();
  ...
  {
    CommonsTestHelper.testDefaultImplementationWithEqualContentObject (new DoubleValidator (), new DoubleValidator ());
  }
}
