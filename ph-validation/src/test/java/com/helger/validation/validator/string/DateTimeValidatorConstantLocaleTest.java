...
public final class DateTimeValidatorConstantLocaleTest
{
  ...
  {
    CommonsTestHelper.testDefaultImplementationWithEqualContentObject (new DateTimeValidatorConstantLocale (Locale.GERMAN),
                                                                       new DateTimeValidatorConstantLocale (Locale.GERMAN));
    CommonsTestHelper.testDefaultImplementationWithDifferentContentObject (new DateTimeValidatorConstantLocale (Locale.GERMAN),
