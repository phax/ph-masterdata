...
public final class DateValidatorConstantLocaleTest
{
  ...
  {
    CommonsTestHelper.testDefaultImplementationWithEqualContentObject (new DateValidatorConstantLocale (Locale.GERMAN),
                                                                       new DateValidatorConstantLocale (Locale.GERMAN));
    CommonsTestHelper.testDefaultImplementationWithDifferentContentObject (new DateValidatorConstantLocale (Locale.GERMAN),
